      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex flex-col md:flex-row gap-16">
          <div className="md:w-1/3 reveal">
            <span className="text-blue-500 font-black tracking-[0.4em] text-[10px] uppercase mb-6 block">Quantum Core</span>
            <h3 className="text-5xl font-black text-white leading-tight tracking-tighter mb-8 italic">
              ZEN<span className="text-blue-500">TRIX</span> <span className="font-thin text-gray-500">Architect.</span>
            </h3>
            <p className="text-gray-500 text-sm leading-relaxed mb-10 uppercase tracking-widest font-medium">
              Interact with our lead automation engine. Describe your bottleneck, and it will compute a custom software roadmap for your enterprise.
            </p>
            <div className="space-y-4">
               {['Compute ROI', 'Draft Architecture', 'Audit Workflow'].map(tag => (
          ...
          <div className="md:w-2/3 glass rounded-[3rem] overflow-hidden border border-white/10 shadow-3xl reveal stagger-1">
            <div className="bg-black/50 p-6 border-b border-white/5 flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-white text-xs font-black tracking-[0.2em] uppercase">Tactical AI Node</p>
                  <p className="text-[9px] text-blue-500 font-bold uppercase tracking-widest">Awaiting Command...</p>
                </div>
              </div>
            ...
            <div ref={scrollRef} className="h-[500px] overflow-y-auto p-10 space-y-8 precision-scrollbar bg-[#050505]/60">
              {messages.length === 0 && (
                <div className="h-full flex flex-col items-center justify-center text-center opacity-20">
                  ...
                  <p className="text-white font-black text-xs uppercase tracking-[0.4em]">Initialize Link Protocol</p>
                </div>
              )}
              {messages.map((msg, i) => (
